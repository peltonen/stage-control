...
edgeLength = 16000; %, 2236, 2000, 1789, 1600, 1431,1280, 1145, 1024, 916, 820, 733, 656, 587, 524, 469, 420, 376, 336, 300];        
offsetX = 0;
offsetY = 0;
numStim = 12000;
maxISI = .03;
...
lz2(200:1:end) = 0;
queueOutputData(s, horzcat(flip(x1), flip(y1), flip(lz1), lz2))
pause(5);
% Output stimulus
s.startForeground()
